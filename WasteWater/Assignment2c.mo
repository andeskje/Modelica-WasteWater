within WasteWater;
package Assignment2c "Component models for the Activated Sludge Model No.1"
...
model SecClarModTakacs "Secondary Clarifier ASM1 Model based on Takacs"
  ...
  package WI = WasteWater.Assignment2c.Interfaces;
...
"));
  ...
  package PreClar "Primary clarifier modelling based on ASM1"
    ...
    model preclar1 "Dynamic ASM1 Primary Clarifier Model"
      ...
      Real XCODin;
      Real H;
      Assignment2c.Interfaces.WWFlowAsm1in In
        annotation (Placement(transformation(extent={{-110,-10},{-90,10}})));
      Assignment2c.Interfaces.WWFlowAsm1out Out
        annotation (Placement(transformation(extent={{90,-10},{110,10}})));
      Assignment2c.Interfaces.WWFlowAsm1out MeasurePort
...
"));
      ...
      model bottom_layer "Bottom layer of Haertel`s SC model"
        import WWSC = WasteWater.Assignment2c.SecClar.Haertel.Interfaces;
        extends WWSC.SCParam;
        extends WWSC.SCVar;
        extends WWSC.ratios;

        Assignment2c.Interfaces.WWFlowAsm1out PQr
          annotation (Placement(transformation(extent={{-70,-110},{-50,-90}})));
        Assignment2c.Interfaces.WWFlowAsm1out PQw
...
"));
      ...
      model SecClarModKrebs "ASM1 Secondary Settling Tank Model based on Krebs"
        ...
        import WWSC = WasteWater.Assignment2c.SecClar.Krebs.Interfaces;
        extends WWSC.SCVar;
        extends WWSC.ratios;
...
"));
      ...
      model bottom_layer "Bottom layer of Otterpohls`s SC model"
        ...
        import WWSC = WasteWater.Assignment2c.SecClar.Otterpohl.Interfaces;
        extends WWSC.SCParam;
        extends WWSC.SCVar;
        extends WWSC.ratios;
        Assignment2c.Interfaces.WWFlowAsm1out PQr
...
"));
    ...
    package Simple "Simple ASM1 Secondary clarifier model"
      ...
      model SimpleSecClarMod "Simple ASM1 Secondary Clarifier Model"
        ...
        extends WasteWater.Assignment2c.SecClar.Takacs.Interfaces.ratios;
        import SI = Modelica.SIunits;
        package WI = WasteWater.Assignment2c.Interfaces;
        package WWU = WasteWater.WasteWaterUnits;
...
"));
      ...
      model bottom_layer "Bottom layer of Takac`s SC model"
        ...
        import WWSC = WasteWater.Assignment2c.SecClar.Takacs.Interfaces;
        extends WWSC.SCParam;
        extends WWSC.SCVar;
        extends WWSC.ratios;
        Assignment2c.Interfaces.WWFlowAsm1out PQr
