...
"));
    ...
    class BenchPlant "COST Benchmark WWTP Configuration"
      ...
      WasteWater.BSM1.pump ReturnPump(Q_max=18446) annotation (Placement(
            ...
            extent={{-10,-10},{10,10}},
            rotation=180)));
      WasteWater.BSM1.pump WastePump(Q_max=385) annotation (Placement(transformation(extent={{59,-55},{79,-35}})));
      ...
      Modelica.Blocks.Sources.CombiTimeTable CombiTableTime(
        ...
        extrapolation=Modelica.Blocks.Types.Extrapolation.HoldLastPoint)
                                             annotation (Placement(transformation(
              extent={{-112,76},{-92,96}})));
      WasteWater.BSM1.WWSource
                    WWSource annotation (Placement(transformation(extent={{-86,76},{
                -66,96}})));
