within WasteWater;
package Assignment3 "Component models for the Activated Sludge Model No.1"
...
model SecClarModTakacs "Secondary Clarifier ASM1 Model based on Takacs"
  ...
  package WI = WasteWater.Assignment3.Interfaces;
...
"));
  ...
  package Examples
    ...
    class SmallPlant "Small WWTP Configuration"
      ...
      WasteWater.Assignment2a.nitri tank2(V=1333)
        annotation (Placement(transformation(extent={{-34,-6},{-14,14}})));
      WasteWater.Assignment2a.deni tank1(V=3000)
      ...
      Modelica.Blocks.Sources.CombiTimeTable CombiTableTime(
        ...
        tableOnFile=("Inf_dry") <> "NoName") annotation (Placement(transformation(
              extent={{-114,79},{-94,99}})));
      WasteWater.Assignment2a.WWSource WWSource
        annotation (Placement(transformation(extent={{-88,78},{-68,98}})));
      WasteWater.Assignment2a.blower blower1(Q_max=34574.2654508612)
        annotation (Placement(transformation(extent={{-33,-62},{-13,-42}})));
      WasteWater.Assignment2a.blower blower2(Q_max=34574.2654508612)
      ...
      WasteWater.Assignment2a.pump RecyclePump(Q_max=46115) annotation (
          Placement(transformation(
            origin={-84,-12},
            extent={{-10,-10},{10,10}},
            rotation=180)));
      WasteWater.Assignment2a.pump ReturnPump(Q_max=9223) annotation (Placement(
            transformation(
            origin={26,-26},
            extent={{-10,-10},{10,10}},
            rotation=180)));
      WasteWater.Assignment2a.pump WastePump(Q_max=193)
    ...
    equation
      ...
      connect(CombiTableTime.y, WWSource.data)
        annotation (Line(points={{-93,89},{-90,89},{-90,88},{-87,88}}));
...
"));
    ...
    class BenchPlant "COST Benchmark WWTP Configuration"
      ...
      WasteWater.Assignment3.nitri_34     tank5(V=1333,
        KLa=1,
        K_nh=20)
        annotation (Placement(transformation(extent={{-6,-26},{14,-6}})));
      WasteWater.Assignment3.nitri_34
                                    tank4(V=1333, KLa=10)
      ...
      Modelica.Blocks.Sources.Constant Constant2 annotation (Placement(
            transformation(extent={{22,-88},{42,-68}})));
      sensor_NH sensor_NH1 annotation (Placement(transformation(extent={{64,-5},
                {80,11}})));
      WasteWater.ASM1.sensor_NO sensor_NO1 annotation (Placement(transformation(
              extent={{81,-5},{97,11}})));
      WasteWater.ASM1.sensor_TKN sensor_TKN1 annotation (Placement(transformation(
      ...
      Modelica.Blocks.Sources.CombiTimeTable CombiTableTime(
        ...
        extrapolation=Modelica.Blocks.Types.Extrapolation.HoldLastPoint)
                                             annotation (Placement(transformation(
              extent={{-112,76},{-92,96}})));
      WasteWater.Assignment3.WWSource  WWSource
      ...
      WasteWater.Assignment2d.SP SP annotation (Placement(transformation(
            ...
            rotation=180,
            origin={81,-89})));
      WasteWater.Assignment3.OCI OCI
        annotation (Placement(transformation(extent={{-1,45},{19,65}})));
    equation
      connect(divider.Out1, Settler.Feed) annotation (Line(points={{40,-13.4},{
              44,-13.4},{44,-13.6},{48,-13.6}}));
      connect(tank5.Out, divider.In) annotation (Line(points={{14,-16},{17,-16},
              {17,-15.7},{20,-15.7}}));
      connect(tank4.Out, tank5.In) annotation (Line(points={{-12,-16},{-6,-16}}));
      connect(tank3.Out, tank4.In) annotation (Line(points={{-40,-16},{-32,-16}}));
      connect(tank3.In, tank2.Out) annotation (Line(points={{-60,-16},{-71,-16},
              {-71,-2},{-19,-2},{-19,12},{-28,12}}));
      connect(tank1.Out, tank2.In) annotation (Line(points={{-56,12},{-48,12}}));
      connect(mixer.Out, tank1.In) annotation (Line(points={{-84,11.6},{-80,
              11.6},{-80,12},{-76,12}}));
      connect(sensor_NO.In, tank2.MeasurePort) annotation (Line(points={{-32,28},
              {-32,16.5},{-32.5,16.5}}));
      connect(divider.Out2, RecyclePump.In) annotation (Line(points={{40,-17.5},
              {44,-17.5},{44,-28.7},{-74,-28.7}}));
      connect(RecyclePump.Out, mixer.In3) annotation (Line(points={{-94,-34.8},
              {-104,-34.8},{-104,7.5}}));
      connect(Settler.Return, ReturnPump.In) annotation (Line(points={{55,-24.6},
              {55,-42.7},{36,-42.7}}));
      connect(ReturnPump.Out, mixer.In2) annotation (Line(points={{16,-48.8},{
              15.5,-48.8},{15.5,-49},{-112,-49},{-112,11.5},{-104,11.5}}));
      connect(WastePump.Out, WasteSludge.In) annotation (Line(points={{79,-62.2},
              {81,-62.2},{81,-62},{83,-62},{83,-62.2},{87,-62.2}}));
      connect(WastePump.In, Settler.Waste) annotation (Line(points={{59,-68.3},
              {52,-68.3},{52,-51},{61,-51},{61,-24.6}}));
      connect(WastePump.u, Constant2.y)
        annotation (Line(points={{60.1,-62.5},{46,-62.5},{46,-78},{43,-78}},
                                                                       color={0,0,
              255}));
      connect(sensor_NH1.In, Settler.Effluent) annotation (Line(points={{72,-5},
              {72,-9.3},{68.2,-9.3}}));
      connect(sensor_NO1.In, Settler.Effluent) annotation (Line(points={{89,-5},
              {89,-9.3},{68.2,-9.3}}));
      connect(sensor_TKN1.In, Settler.Effluent) annotation (Line(points={{105,-6},
              {105,-9.3},{68.2,-9.3}}));
      connect(sensor_COD1.In, Settler.Effluent) annotation (Line(points={{105,-25},
              {105,-9.3},{68.2,-9.3}}));
      connect(Effluent.In, Settler.Effluent) annotation (Line(points={{96,-33},
              {76.5,-33},{76.5,-9.3},{68.2,-9.3}}));
      connect(Constant2.y, ReturnPump.u)
        annotation (Line(points={{43,-78},{46,-78},{46,-48.5},{34.9,-48.5}},
                                                                         color={0,
              0,255}));
      connect(sensor_TSS1.In, divider.Out1) annotation (Line(points={{40,-5},{
              40,-13.4}}));

      connect(RecyclePump.u, Constant1.y) annotation (Line(
          points={{-75.1,-34.5},{-65,-34.5},{-65,-66},{-72,-66}},
          color={0,0,127},
          smooth=Smooth.None));
      connect(mixer.In1,WWSource. Out) annotation (Line(points={{-104,15.5},{
              -104,37},{-66,37},{-66,79},{-66.2,79}}));
      connect(CombiTableTime.y,WWSource. data)
        annotation (Line(points={{-91,86},{-85,86}}));
      connect(tank1.T, Constant3.y) annotation (Line(
          points={{-76,16},{-77,16},{-77,26},{-56,26},{-56,65},{-44,65}},
          color={0,0,127},
          smooth=Smooth.None));
      ...
      connect(tank2.T, tank3.T) annotation (Line(
          points={{-48,16},{-54,16},{-54,-12},{-60,-12}},
          color={0,0,127},
          smooth=Smooth.None));
      ...
      connect(OCI.AE, AE.AE)
        annotation (Line(points={{3,46},{3.8,46},{3.8,22}}, color={0,0,127}));
      connect(OCI.PE, PE.PE) annotation (Line(points={{6,46},{-22,46},{-22,49},{-48,
              49},{-48,-72},{-41.8,-72}},      color={0,0,127}));
      connect(OCI.SP, SP.SP) annotation (Line(points={{9,46},{61,46},{61,-89},{
              71.2,-89}}, color={0,0,127}));
      connect(OCI.EQ, EQ.EQ) annotation (Line(points={{12,46},{40,46},{40,-47},
              {67.2,-47}}, color={0,0,127}));
      connect(OCI.ME, ME.ME) annotation (Line(points={{15,46},{27,46},{27,22},{
              26.8,22}}, color={0,0,127}));
      connect(SP.Qw, WastePump.Q) annotation (Line(points={{86,-80},{78,-80},{
              78,-72},{69,-72}}, color={0,0,127}));
      annotation (
        Diagram(coordinateSystem(
            preserveAspectRatio=false,
            extent={{-120,-100},{120,105}},
...
air between blower and nitrification tank."));
    ...
    partial model stoichiometry "BSM1 stoichiometric coefficients"
    ...
    partial model ASM1base "Base class of WWTP modelling by ASM1"
      ...
      Real mu_a "Maximum autotrophic growth rate f(
  ) [day^-1]";
...
"));
  ...
  package PreClar "Primary clarifier modelling based on ASM1"
    ...
    model preclar1 "Dynamic ASM1 Primary Clarifier Model"
      ...
      Real XCODin;
      Real H;
      Assignment3.Interfaces.WWFlowAsm1in In
        annotation (Placement(transformation(extent={{-110,-10},{-90,10}})));
      Assignment3.Interfaces.WWFlowAsm1out Out
        annotation (Placement(transformation(extent={{90,-10},{110,10}})));
      Assignment3.Interfaces.WWFlowAsm1out MeasurePort
...
"));
      ...
      model SecClarModHaertel
        ...
        package SCP = Haertel;
        import SI = Modelica.SIunits;
        package WI = WasteWater.Assignment2a.Interfaces;
        package WWU = WasteWater.WasteWaterUnits;
        parameter SI.Length hsc=4.0 "height of secondary clarifier";
        parameter Integer n=10 "number of layers of SC model";
        parameter SI.Length zm=hsc/(1.0*n)
...
"));
      ...
      model bottom_layer "Bottom layer of Haertel`s SC model"
        import WWSC = WasteWater.Assignment3.SecClar.Haertel.Interfaces;
        extends WWSC.SCParam;
        extends WWSC.SCVar;
        extends WWSC.ratios;

        Assignment3.Interfaces.WWFlowAsm1out PQr
          annotation (Placement(transformation(extent={{-70,-110},{-50,-90}})));
        Assignment3.Interfaces.WWFlowAsm1out PQw
...
"));
      ...
      model SecClarModKrebs "ASM1 Secondary Settling Tank Model based on Krebs"
        ...
        import WWSC = WasteWater.Assignment3.SecClar.Krebs.Interfaces;
        extends WWSC.SCVar;
        extends WWSC.ratios;
...
"));
      ...
      model bottom_layer "Bottom layer of Otterpohls`s SC model"
        ...
        import WWSC = WasteWater.Assignment3.SecClar.Otterpohl.Interfaces;
        extends WWSC.SCParam;
        extends WWSC.SCVar;
        extends WWSC.ratios;
        Assignment3.Interfaces.WWFlowAsm1out PQr
...
"));
    ...
    package Simple "Simple ASM1 Secondary clarifier model"
      ...
      model SimpleSecClarMod "Simple ASM1 Secondary Clarifier Model"
        ...
        extends WasteWater.Assignment3.SecClar.Takacs.Interfaces.ratios;
        import SI = Modelica.SIunits;
        package WI = WasteWater.Assignment3.Interfaces;
        package WWU = WasteWater.WasteWaterUnits;
...
"));
      ...
      model bottom_layer "Bottom layer of Takac`s SC model"
        ...
        import WWSC = WasteWater.Assignment3.SecClar.Takacs.Interfaces;
        extends WWSC.SCParam;
        extends WWSC.SCVar;
        extends WWSC.ratios;
        Assignment3.Interfaces.WWFlowAsm1out PQr
...
model OCI "What is this"
  ...
  Modelica.Blocks.Interfaces.RealOutput OCI annotation (Placement(transformation(extent={{88,-10},{108,10}})));
  ...
  Modelica.Blocks.Interfaces.RealInput SP annotation (Placement(transformation(extent={{-10,-10},
        ...
        rotation=270,
        origin={0,-90})));
  Modelica.Blocks.Interfaces.RealInput EQ annotation (Placement(transformation(extent={{-10,-10},
            {10,10}},
        rotation=270,
        origin={30,-90})));
